...
import atomic.diagram.edit.policies.AtomicTextSelectionEditPolicy;
import atomic.diagram.part.AtomicVisualIDRegistry;
import atomic.diagram.providers.AtomicElementTypes;
import atomic.diagram.providers.AtomicParserProvider;

/**
 * @generated
 */
public class ATokenTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ATokenTextEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new AtomicTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new AGraphEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return AtomicElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AtomicParserProvider
					.getParser(
							AtomicElementTypes.AToken_2002,
							getParserElement(),
							AtomicVisualIDRegistry
									.getType(atomic.diagram.edit.parts.ATokenTextEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					AtomicEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
