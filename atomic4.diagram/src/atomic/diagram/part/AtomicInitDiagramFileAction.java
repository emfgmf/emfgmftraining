 ...
 * @generated
 */
public class AtomicInitDiagramFileAction implements
	...
	public void run(IAction action) {
		TransactionalEditingDomain editingDomain = GMFEditingDomainFactory.INSTANCE
				.createEditingDomain();
		Resource resource = AtomicDiagramEditorUtil.openModel(getShell(),
		...
		Wizard wizard = new AtomicNewDiagramFileWizard(resource.getURI(),
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				AGraphEditPart.MODEL_ID));
		AtomicDiagramEditorUtil
