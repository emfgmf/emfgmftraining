 ...
 * @generated
 */
public class AtomicDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.AtomicDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									Messages.AtomicDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = AtomicDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI, final File corpusTextFile, 
		...
		progressMonitor.beginTask(
				Messages.AtomicDiagramEditorUtil_CreateDiagramProgressTask, 3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.AtomicDiagramEditorUtil_CreateDiagramCommandLabel,
			...
			protected CommandResult doExecuteWithResult(
				...
				try {
					modelResource
							.save(atomic.diagram.part.AtomicDiagramEditorUtil
									.getSaveOptions());
					diagramResource
							.save(atomic.diagram.part.AtomicDiagramEditorUtil
									.getSaveOptions());
	 ...
	 * @generated
	 */
	private static AGraph createInitialModel() {
		return AtomicFactory.eINSTANCE.createAGraph();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(AGraph model, Resource resource) {
